...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a simple student classifier and log with MLflow")
...
def load_data() -> tuple[pd.DataFrame, pd.Series, dict]:
    ...
    class_map = {int(i): str(name) for i, name in enumerate(df.target_names)}
...
def main():
    ...
    mlflow.set_experiment("student-classification")
